...
//                );
//
//                // IMPORTANT: Activity ke FragmentManager use karo
//                requireActivity()
//                        .getSupportFragmentManager()
//                        .beginTransaction()
//                        .replace(R.id.main_container, detailFragment)  // container jo activity mein hai
//                        .addToBackStack("order_detail")    // taake back press pe wapas aaye
//                        .commit();
//            });
//
//        }
