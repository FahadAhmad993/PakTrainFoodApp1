...
//
//    // 🔹 New field added safely (for Order tracking)
//    private String orderStatus = "active";
//    // Possible values: "active", "accepted", "delivered", "completed"
//
...
//        this.restaurantName = restaurantName;
//        this.restaurantCity = restaurantCity;
//        this.orderStatus = "active"; // default
//    }
//
//    // 🔹 Getters & Setters
//    public String getId() { return id; }
...
//    public void setRestaurantCity(String restaurantCity) { this.restaurantCity = restaurantCity; }
//
//    // 🔹 Added orderStatus support (for OrderFragment filters)
//    public String getOrderStatus() { return orderStatus; }
//    public void setOrderStatus(String orderStatus) { this.orderStatus = orderStatus; }
//
//
