...
//                        String restaurantName = restDoc.getString("restaurantName");
//
//                        // Step 2: For each restaurant, get its MenuItems
//                        db.collection("Users")
//                                .document("Restaurant")
//                                .collection("VerifiedRegister")
//                                .document(restaurantId)
...
//                                        item.setId(menuDoc.getId());
//                                        item.setRestaurantId(restaurantId);
//                                        item.setRestaurantName(restaurantName); // Attach restaurant name
//                                        itemList.add(item);
//                                    }
//                                    adapter.notifyDataSetChanged();
//                                    progressBar.setVisibility(View.GONE);
...
//                                            "Failed to load menu for " + restaurantName,
...
//                        progressBar.setVisibility(View.GONE);
//                        Toast.makeText(requireContext(),
//                                "No menu items available from any restaurant",
//                                Toast.LENGTH_SHORT).show();
//                    }
//                })
//                .addOnFailureListener(e -> {
